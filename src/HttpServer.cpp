...
constexpr const char* kProgramRelease = "Release 23";
constexpr const char* kProgramVersion = "v137";
...
function openAboutModal() {
  openModal(`
    ...
    <div class="about-list">
      ...
      <div class="about-row"><strong>${t('version')}</strong><span>${state.program_release||'Release 23'} / ${state.program_version||'v137'}</span></div>
